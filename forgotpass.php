...
<div class="container">
    <div class="card shadow">
        ...
        <div class="card-body">
            <input type="text" class="form-control form-control-lg my-4" placeholder="juandelacruz@gmail.com" required>
            <center><label><span style="color: green">Email</span>/Enter OTP/New Password</label></center>
            <center><a href="otp.php" class="btn btn-success btn-lg mt-3">Send OTP</a></center>
        </div>
        <div class="mx-auto">
